...
<br> <br> <a href="/KimsApplicationSpring/patient_home">Home</a> | <a
			href="/KimsApplicationSpring/patient_profile">Profile</a> | 
...
<form:form action="/KimsApplicationSpring/update_patient" method="post" modelAttribute="pprofile" align="center">
