...
<br><br>
<a href="/KimsSpringAnnotations/patient_home">Home</a> |
<a href="/KimsSpringAnnotations/patient_profile">Profile</a> |
<a href="/KimsSpringAnnotations/appointment_status">Appointment status</a> |
<a href="/KimsSpringAnnotations/index">Logout</a>
</center>
<br><br>
<form:form action="/KimsSpringAnnotations/apply_appointment" method="post" modelAttribute="appointment"  align="center">
