...
<body bgcolor="lightskyblue">
	...
	<center>
		...
		<br> <br> <a href="/KimsSpringAnnotations/doctor_home">Home</a>
		| <a href="/KimsSpringAnnotations/doctor_profile">Profile</a> | <a
			href="/KimsSpringAnnotations/view_appointment">Appointment
			Details</a> | <a href="/KimsSpringAnnotations/index">Logout</a>
	</center>
	<br>
	<br>
	<table border="2" align="center" width="600" height="100" cellpadding="20">
		...
		<c:forEach var="vab" items="${vlist}">
			<tr>
				...
				<c:if test="${vab.getStatus() != 'Accepted'}">
					<td><a href="/KimsSpringAnnotations/accept/${vab.getId()}">Accept</a></td>
				</c:if>
			</tr>
		</c:forEach>
