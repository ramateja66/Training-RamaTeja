...
<th style="text-align:centre;" width="10%">Bike Model</th>
<th style="text-align:centre;" width="10%">Bike Type</th>
<th style="text-align:centre;" width="10%">Proofs Required</th>
<th style="text-align:centre;" width="10%">Rent(per day)</th>
<th style="text-align:centre;" width="10%">Store Email</th>
...
<td><a href="bikerentstatus.jsp?id=<%=rs.getString(1)%>">Book</a></td>
</tr>
<%}%>
</table>
</div>
