	...
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="usersbdetails.jsp" class="smoothScroll">Back</a></li>
			</ul>
		</div>
...
String x=(String)session.getAttribute("uemail");
String sql="select * from sellbike";
...
<th style="text-align:centre;">Year of Purchasing</th>
<th style="text-align:centre;">Price</th>
<th style="text-align:centre;">User Email</th>
<th style="text-align:centre;">Colour</th>
<th style="text-align:centre;">Trip</th>
</tr>
<%while(rs.next())
{%>
<tr style="background-color: #ddd;">
