...
%>		
								...
								<tr>
									...
									<td><input type="text" name="gs" value="<%=rs.getString(2)%>" required style="color: #080808;"></td>
									...
									<td><input type="text" name="oc" value="<%=rs.getString(3)%>" required style="color: #080808;"></td>
									</div>
									</tr>
									<tr>
									<div>
									<th><label>Electrical Issues</label></th>
									<td><input type="text" name="ei" value="<%=rs.getString(4)%>" required style="color: #080808;"></td>
									</div>
									</tr>
									<tr>
									<div>
									<th><label>Clutch/Break Issues</label></th>
									<td><input type="text" name="cbs" value="<%=rs.getString(5)%>" required style="color: #080808;"></td>
									</div>
									</tr>
									<tr>
									<div>
									<th><label>Engine/Silencer Issues</label></th>
									<td><input type="text" name="eni" required style="color: #080808;" value="<%=rs.getString(6)%>"></td>
									</div>
									</tr>
									<tr>
									<div>
									<th><label>Chain/Sprocket Issues</label></th>
									<td><input type="text" name="csi" value="<%=rs.getString(7)%>" required style="color: #080808;"></td>
									</div>
									</tr>
									<tr>
									<div>
									<th><label>Filter Change</label></th>
									<td><input type="text" name="fc" value="<%=rs.getString(8)%>" required style="color: #080808;"></td>
									</div>
									</tr>
									<tr>
									<div>
									<th><label>Repaint/Scratch Issues</label></th>
									<td><input type="text" name="rsr" value="<%=rs.getString(9)%>" required style="color: #080808;"></td>
									</div>
									</tr>
									<tr>
									<div>
									<th><label>Tyre Puncture/Replacement</label></th>
									<td><input type="text" name="tpr" value="<%=rs.getString(10)%>" required style="color: #080808;"></td>
									</div>
									</tr>
									<tr>
									<div>
