...
String sql="select * from brent where bsemail='"+bsemail+"'";
...
<th style="text-align:centre;" >Proofs Required</th>
<th style="text-align:centre;" >Rent(per day)</th>
...
<td><a href="bikerentupdate.jsp?id=<%=rs.getString(1)%>">Update</a></td>
</tr>
<%}%>
</table>
</div>
