	...
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="adminudetails.jsp" class="smoothScroll">User Details</a></li>
                <li><a href="adminbdetails.jsp" class="smoothScroll">Bike Details</a></li>
                <li><a href="adminbsdetails.jsp" class="smoothScroll">BikeStore Details</a></li>
        		<!--<li><a href="#newsletter" class="smoothScroll">Bike Review</a></li>
				<li><a href="#newsletter" class="smoothScroll">Sell Bike</a></li>
				<li><a href="#newsletter" class="smoothScroll">Bike Servicing</a></li>-->
