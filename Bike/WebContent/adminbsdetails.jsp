...
<th style="text-align:centre;" width="20%">Store Name</th>
<th style="text-align:centre;" width="25%">Email</th>
<th style="text-align:centre;" width="20%">Phone</th>
<th style="text-align:centre;" width="25%">Address</th>
<th style="text-align:centre;" width="25%">Pincode</th>
</tr>
<%while(rs.next())
{%>
<tr style="background-color: #ddd;">
