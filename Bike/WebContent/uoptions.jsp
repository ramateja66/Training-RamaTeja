	...
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="userbfdetails.jsp" class="smoothScroll">Buy Bike </a></li>
                <li><a href="userrdetails.jsp" class="smoothScroll">Rent</a></li>
        		<li><a href="userbrdetails.jsp" class="smoothScroll">Bike Review</a></li>
				<!--<li><a href="usersbdetails.jsp" class="smoothScroll">Sell Bike</a></li>-->
				<li><a href="userbsdetails.jsp" class="smoothScroll">Bike Servicing</a></li>
