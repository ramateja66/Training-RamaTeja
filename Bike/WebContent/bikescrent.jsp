...
String sql="select * from rentstatus where bsemail='"+bsemail+"'";
...
<th style="text-align:centre;">Bike Model</th>
<th style="text-align:centre;">Bike Type</th>
<th style="text-align:centre;">Rent</th>
<th style="text-align:centre;">Booking Date</th>
<th style="text-align:centre;">Customer Email</th>
<th style="text-align:centre;">Pickup Time</th>
<th style="text-align:centre;">Dropping Time</th>
...
<td><%=rs.getInt(11)%>:<%=rs.getInt(12)%></td>
<td><%=rs.getInt(13)%>:<%=rs.getInt(14)%></td>
<td><%=rs.getString(10)%></td>
<td><a href="caltime1.jsp?id=<%=rs.getString(1)%>">Click</a></td>
</tr>
<%}%>
</table>
</div>
