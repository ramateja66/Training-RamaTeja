	...
	<div class="container">
		<div class="row">
               ...
               <div class="wow fadeInUp col-md-6 col-sm-5 col-xs-10 col-xs-offset-1 col-sm-offset-0" data-wow-delay="0.2s">
                    <img src="images/seller-page.jpeg" class="img-responsive" alt="Home" style="padding-right: 10‒; padding-right: 80px; padding-left: 20px;">
               </div>

               <div class="col-md-6 col-sm-7 col-xs-12">
			   
			   <div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span><font size="6">Seller Login</h3>
									</font></div>
								<form action="bslogincheck.jsp" method="post">
								<table>
								<tr>
									<div>
									...
									<td><input type="password" name="password" placeholder="enter password" required style="color: #080808;" required></td>
									</div>
									</tr>
									<tr>
									<div>
									<td><input type="submit" value="login" style="background-color: #9d9d9d;"></td>
									<td><input type="reset" value="reset" style="background-color: #9d9d9d;"></td>							
									<td style="background-color: #999;"><h5>Not Registered</h5><a href="bsreg.jsp" style="background-color: #eee;">Click Here</a></td></div></tr>
									</table>
									</form>
