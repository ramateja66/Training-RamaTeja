	...
	<div class="container">
		<div class="row">
               ...
               <div class="wow fadeInUp col-md-6 col-sm-5 col-xs-10 col-xs-offset-1 col-sm-offset-0" data-wow-delay="0.2s">
                    <img src="images/admin-img.jpeg" class="img-responsive" alt="Home" style="padding-right: 10‒; padding-right: 80px; padding-left: 20px;">
               </div>

               <div class="col-md-6 col-sm-7 col-xs-12">
			   
			   <div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span><font size="6">Admin Login</h3>
									</font></div>
