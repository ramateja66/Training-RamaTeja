	...
	<div class="container">
		<div class="row">
               ...
               <div class="wow fadeInUp col-md-6 col-sm-5 col-xs-10 col-xs-offset-1 col-sm-offset-0" data-wow-delay="0.2s">
                    <img src="images/user-img.jpeg" class="img-responsive" alt="Home" style="padding-right: 10‒; padding-right: 80px; padding-left: 20px;">
               </div>
			   ...
			   <div class="panel-heading">
							...
							<table>
								<tr>
									...
									<td style="background-color: #999;"><h5>Not Registered</h5><a href="ureg.jsp" style="background-color: #eee;">Click Here</a></td></div></tr>
									</table>
									</form>
