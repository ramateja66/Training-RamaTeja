	...
	<div class="container">
		<div class="row">
			   ...
			   <div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span><font size="6"> Register here(Bike Store)</h3>
									</font></div>
								<form action="bsinsert.jsp" method="post" name="rform" onsubmit="return ValidateForm()">
								<table>
								<tr>
									<div>
									<th><label>Store Name</label></th>
									<td><input type="text" name="bsname" placeholder="enter user name" required style="color: #080808;"></td>
									</div>
									</tr>
									<tr><div>
									<th><label>Store Email</label></th>
									<td><input type="email" name="bsemail" placeholder="enter email" required style="color: #080808;"></td>
									</div>
									</tr>
									<tr>
									<div>
									<th><label>Phone number</label></th>
									<td><input type="text" name="bsphone" placeholder="enter phone number" required style="color: #080808;"></td>
									</div>
									</tr>
									<tr>
									<div>
									<th><label>Address</label></th>
									<td><textarea cols="22" name="bsadd" placeholder="enter address" required style="color: #080808;"></textarea></td>
									</div>
									</tr>
									<tr>
									<div>
									<th><label>Pincode</label></th>
									<td><input type="text" name="pincode" placeholder="enter pincode" required style="color: #080808;"></td>
									</div>
									</tr>
									<tr>
									<div>
