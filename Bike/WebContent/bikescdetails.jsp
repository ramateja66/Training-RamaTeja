	...
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="alogin.jsp" class="smoothScroll">Admin</a></li>-->
				<li><a href="bikescservice.jsp" class="smoothScroll">Bike Servicing</a></li>
				<li><a href="bikescrent.jsp" class="smoothScroll">Rental</a></li>
		...
		<div class="row">
              ...
              <!-- <div class="col-md-6 col-sm-7 col-xs-12">
			   ...
			   <div class="panel-heading">
									<h3 class="panel-title"><span class="fa fa-pencil-square-o"></span><font size="6">User Login</h3>
									</font></div>
								...
								<tr>
									...
									<td style="background-color: #999;"><h5>Not Registered</h5><a href="index.html" style="background-color: #eee;">Click Here</a></td></div></tr>
									</table>
									</form>-->
