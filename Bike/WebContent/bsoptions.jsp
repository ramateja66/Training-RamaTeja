	...
	<div class="container">
		...
		<div class="collapse navbar-collapse">
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="#screenshot" class="smoothScroll"></a></li>
                <li><a href="#pricing" class="smoothScroll"></a></li>
                
        		<li><a href="bikesbdetails.jsp" class="smoothScroll">Bike Details</a></li>
			<li><a href="bsbdetails.jsp" class="smoothScroll">Purchased Bike Details</a></li>
				<li><a href="bikescdetails.jsp" class="smoothScroll">Customer Details</a></li>
				<li><a href="bikessdetails.jsp" class="smoothScroll">Servicing Details</a></li>
				<li><a href="bikesrdetails.jsp" class="smoothScroll">Rent</a></li>
